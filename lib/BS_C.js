        ...
        if(CACHE.battle.selfIndex === monsterBaseInfo.side) {
				...
				CACHE.battle.roundMonsterCount +=1
                    ...
                    var UnmergeBall = function(_keyList) {
                        ...
                        if(CACHE.battle.currentRound >200 &&  CACHE.battle.runUnMergeCount<2  && CACHE.battle.roundMonsterCount<9 && ((CACHE.battle.currentRound%2)==1) &&(CACHE.battle.MonsterType < 101 || CACHE.battle.MonsterType > 106)){
                            //echo('match merge')
                            keyList = CACHE.getBallKeysSort();
